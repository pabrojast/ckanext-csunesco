...
ICONS = {
    ...
    'users': ('<circle cx="9" cy="8" r="3.2"/>'
              ...
              '3.1 4.6"/>'),
    'media-text': ('<rect x="3.5" y="6" width="7.5" height="8" rx="1.5"/>'
                   '<path d="M14 7.5h6.5M14 11h6.5M14 14.5h6.5M3.5 18h17"/>'),
    # UI glyphs
    'up': '<path d="M12 19V5M6 11l6-6 6 6"/>',
    'pencil': ('<path d="m4.5 19.5 1-3.8L16.4 4.8a2 2 0 0 1 2.8 2.8L8.3 '
               '18.5l-3.8 1z"/><path d="m14.6 6.6 2.8 2.8"/>'),
    'down': '<path d="M12 5v14M6 13l6 6 6-6"/>',
    'trash': ('<path d="M4.5 7h15M9.5 7V4.5h5V7M7 7l.9 13h8.2L17 '
              '7M10.2 11v5M13.8 11v5"/>'),
    'eye': ('<path d="M2.5 12s3.5-5.8 9.5-5.8 9.5 5.8 9.5 5.8-3.5 '
            '5.8-9.5 5.8S2.5 12 2.5 12z"/><circle cx="12" cy="12" r="3"/>'),
